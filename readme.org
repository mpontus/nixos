...
#+begin_src nix :noweb-ref overlays
(self: super: { emacs = super.emacs.override { withXwidgets = true; }; })
#+end_src
...
#+begin_src nix :noweb-ref overlays
(self: super: {
  emacs = super.emacs.pkgs.withPackages (epkgs: [ epkgs.vterm ]);
})
#+end_src
